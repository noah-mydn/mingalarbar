    ...
    >
      <Box display="flex" justifyContent="flex-end" px={1}>
        <IconButton onClick={handleDrawerToggle}>
          <CloseIcon sx={{ color: theme.palette.info.light }} />
        </IconButton>
      </Box>
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <MenuIcon sx={{ color: theme.palette.info.light }} />
        </IconButton>

        <Box
          component="img"
          src="./assets/images/mingalarbar.png"
          width="120px"
          height="70px"
        />
        ...
        <Box display="flex">
          {/* <Box display='flex' alignItems='center' px={1}>
                        <LoginIcon color='tertiary'main{display:tabletScreen ? 'none' : 'block'}}/>
                        <Typography variant='body2' color='tertiary'main1}>
                            LogIn
                        </Typography>
                        <ArrowDropDownIcon color='tertiarymain                     id="login-btn"
                    ...
                    <Box display={tabletScreen ? 'none':'flex'} alignItems='center' px={1}>
                            <PersonIcon color='tertiarymain                      <Typography variant='body2' color='tertiary'main1}>
                            SignUp
                        </Typography>
                    </Box> */}
          <IconButton>
