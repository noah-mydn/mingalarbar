...
import { Box, Card, CardMedia, Typography, CardActions, CardActionArea, CardContent, Button } from '@mui/material'
    ...
    const BlogContainer = ({url,alt,title,desc}) => {
        return (
            <Card sx={{ maxWidth: 300, 
                ...
                <Typography gutterBottom variant="h5" component="div" fontFamily='Jost'>
                    {title}
                </Typography>
